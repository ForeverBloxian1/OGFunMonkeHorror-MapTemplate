...
namespace OGFunMonkeHorror.Editor
{
    public class WelcomeWindow : EditorWindow
    {
        ...
        {
            var win = GetWindow<WelcomeWindow>(true, "OG Fun Monke Horror — Welcome", true);
        ...
        private void OnGUI()
        {
            ...
            EditorGUILayout.HelpBox(
                "1. Select the MapRoot GameObject in the Hierarchy.\n\n" +
                "2. Fill in your Map Name, Portal Color, and Lighting in the Inspector.\n\n" +
                "3. Build your level inside MapRoot/Environment.\n\n" +
                "4. Open OG Fun Monke Horror \u2192 Guide for full documentation.",
                MessageType.None);
